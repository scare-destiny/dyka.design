	...
	return (
		<div className='dyka__about'>
			<div className='dyka__about-text_container section__padding'>
				<p>
					Hi, my name is Anastasiia, and welcome to my website! My passion for design
					and understanding clients' needs is what I have lived and breathed the last
					decade. For me, talent results from discipline, so I push myself every day
					to improve.
				</p>
				<p>
